...
> 目前CRM仅提合同审批及创建功能，订单、发货过账、开票仍在ERP中操作，ERP做完后会自动将订单、发货、发票同步到CRM系统中

##### 6.SAP发货后多久CRM中合同状态会变更为发货中？

> SAP发货后，一般5-10分钟会更新CRM合同的发货状态，如果等不及，可以在PC端发货单列表点击立即同步按钮将合同关联的发货单同步过来，之后合同状态会变为发货中
