...
合同分类选择补充协议，然后在下方的合同变更出勾选变更

![](/assets/htbgal12313.png)

选择原合同处理方式，输入原合同编号，补充协议内容，如果本次变更需要PMC或品质审批，请勾选前面复选框，如果本次更新不会生成新合同，请在是否更新SAP处选择否

> 如果不涉及SAP中内容更新，则请不要勾选更新SAP选项。
>
> 勾选了SAP更新选项，则系统会自动再SAP中重建合同，原合同需要关闭
